              ...
              {days.length === 0 && (
                <div className="bg-white rounded-[3rem] p-20 text-center border border-dashed border-gray-200">
                   <div className="w-24 h-24 bg-gray-50 rounded-[2rem] flex items-center justify-center mx-auto mb-8">
                      <FaCalendarAlt className="text-gray-200 text-5xl" />
                   </div>
                   <h3 className="text-2xl font-black text-gray-900 mb-2">Belum Ada Struktur Jadwal</h3>
                   <p className="text-gray-500 font-bold mb-10 max-w-xs mx-auto">Mulai dengan menambahkan hari untuk menyusun kurikulum mingguan kelas.</p>
                   <button 
                     type="button" 
                     onClick={addDay} 
