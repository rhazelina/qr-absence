...
class RiwayatKehadiranKelasPengurusActivity : BaseNetworkActivity() {
    ...
    private fun setupStatistik() {
        loadAttendanceStatisticsFromApi()
    }

    private fun setupSiswaData() {
        // Placeholder for loading student data from API
        // This can be implemented later when needed
    }

    private fun loadAttendanceStatisticsFromApi() {
