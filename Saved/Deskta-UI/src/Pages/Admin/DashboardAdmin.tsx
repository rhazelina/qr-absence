...
export default function AdminDashboard({
  ...
  useEffect(() => {
    ...
    /** Fetch real school summary stats */
    api.get('/admin/summary')
      .then((data) => {
        const d = data as Record<string, unknown>;
        setAdminSummary({
          total_classes: (d.total_classes as number) ?? (d.classes as number) ?? 0,
          total_students: (d.total_students as number) ?? (d.students as number) ?? 0,
          total_teachers: (d.total_teachers as number) ?? (d.teachers as number) ?? 0,
          total_rooms: (d.total_rooms as number) ?? (d.rooms as number) ?? 0,
        });
      })
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {adminSummary ? adminSummary.total_classes.toLocaleString('id-ID') : '–'}
                      </div>
                      <div
                        style={{
                          fontSize: "16px",
                    ...
                    >
                      ...
                      >
                        {adminSummary ? adminSummary.total_students.toLocaleString('id-ID') : '–'}
                      </div>
                      <div
                        style={{
                          fontSize: "16px",
                    ...
                    >
                      ...
                      >
                        {adminSummary ? adminSummary.total_teachers.toLocaleString('id-ID') : '–'}
                      </div>
                      <div
                        style={{
                          fontSize: "16px",
                    ...
                    >
                      ...
                      >
                        {adminSummary ? adminSummary.total_rooms.toLocaleString('id-ID') : '–'}
                      </div>
                      <div
                        style={{
                          fontSize: "16px",
