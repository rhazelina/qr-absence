...
class SimpleGuruAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val btnViewAttachment: ImageButton? = view.findViewById(R.id.btn_view_attachment)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        try {
            ...
            val attachmentUrl = data["attachmentUrl"]?.toString().orEmpty()
            holder.btnViewAttachment?.apply {
                visibility = if (attachmentUrl.isNotBlank()) View.VISIBLE else View.GONE
                setOnClickListener {
