...
class RiwayatKehadiranSiswa : BaseNetworkActivity() {
    ...
    // ===== API-LOADED DATA =====
    private var semuaKehadiran = mutableListOf<KehadiranItem>()
