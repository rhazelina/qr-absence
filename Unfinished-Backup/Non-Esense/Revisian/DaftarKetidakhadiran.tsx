...
export default function DaftarKetidakhadiran({
  ...
  const [rows] = useState<RowKehadiran[]>([
    ...
    },
    {
      ...
      guru: "SOLIKAH, S.Pd",
      status: "Dispen",
      keterangan: "Mendapat dispensasi untuk mengikuti lomba tingkat provinsi",
      buktiFoto: "surat-dispensasi.jpg",
    },
  ]);
  ...
  const getStatusText = (status: StatusKehadiran) => {
    switch (status) {
      ...
      case "Dispen": return "Siswa mendapat dispensasi dari sekolah";
      default: return "";
    }
  };
  ...
  const DetailRow = ({ label, value }: { label: string; value: string }) => (
    <div style={{
      ...
      <div style={{ fontWeight: 600, color: "#374151", width: 130, flexShrink: 0 }}>{label}</div>
      <div style={{ fontWeight: 600, color: "#374151", width: 16, flexShrink: 0, textAlign: "center" }}>:</div>
      <div style={{ color: "#6B7280", textAlign: "right", flex: 1 }}>{value}</div>
    </div>
  );
          ...
          <div style={{
            ...
            <div style={{ padding: 24, overflowY: "auto", flex: 1 }}>
              ...
              <div style={{
                ...
                <div style={{ fontWeight: 600, color: "#374151", width: 130, flexShrink: 0 }}>Status</div>
                <div style={{ fontWeight: 600, color: "#374151", width: 16, flexShrink: 0, textAlign: "center" }}>:</div>
              ...
              {/* Keterangan dan Bukti Foto - untuk Izin, Sakit, Pulang, Dispen */}
