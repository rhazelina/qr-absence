...
const monthlyTrendData = [
  { month: "Jan", hadir: 8, izin: 5, sakit: 3, alpha: 2, pulang: 1, dispen: 1 },
  { month: "Feb", hadir: 9, izin: 5, sakit: 2, alpha: 3, pulang: 1, dispen: 2 },
  { month: "Mar", hadir: 10, izin: 4, sakit: 3, alpha: 2, pulang: 1, dispen: 1 },
  { month: "Apr", hadir: 11, izin: 2, sakit: 2, alpha: 1, pulang: 2, dispen: 3 },
  { month: "Mei", hadir: 12, izin: 3, sakit: 1, alpha: 2, pulang: 1, dispen: 2 },
  { month: "Jun", hadir: 13, izin: 3, sakit: 2, alpha: 1, pulang: 2, dispen: 1 },
];
