...
function Dashboard() {
  ...
  const loadDashboardStats = async () => {
    ...
    if (result.data) {
      setStats({
        totalMurid: result.data.total_students || result.data.students || 0,
        totalGuru: result.data.total_teachers || result.data.teachers || 0,
        totalKelas: result.data.total_classes || result.data.classes || 0,
        totalJurusan: result.data.total_majors || result.data.majors || 0
      });
    }
