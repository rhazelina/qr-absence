...
class DashboardController extends Controller
{
     ...
     * Returns today's teaching schedule and attendance summary per subject
     * 
     * Statistics are calculated per subject taught TODAY:
     * - hadir (present)
     * - izin (permission)
     * - sakit (sick)
     * - alpha (absent)
    ...
    public function teacherDashboard(Request $request): JsonResponse
    {
        ...
        $scheduleToday = $schedules->map(function ($schedule) use ($attendances, $studentsOnLeave, $today) {
