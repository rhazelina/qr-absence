...
import { calculateWeeklyStatsForStudent, calculateMonthlyTrendForStudent } from '../../data/attendanceData';

// Sample Data - Profile siswa (hardcoded untuk contoh)
const sampleData = {
  profile: {
    name: 'Budi Santoso',
    kelas: 'XII RPL 2',
    id: '00123456',
    gender: 'laki-laki',
    studentId: 3 // ID siswa di data (Budi Santoso = ID 3)
  },
...
const Dashboard = () => {
  ...
  // Hitung statistik dari data dummy untuk siswa ini
  const weeklyStats = calculateWeeklyStatsForStudent(sampleData.profile.studentId);
  const monthlyTrend = calculateMonthlyTrendForStudent(sampleData.profile.studentId);
