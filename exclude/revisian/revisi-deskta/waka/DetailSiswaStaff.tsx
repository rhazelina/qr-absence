...
const MATA_PELAJARAN_GURU: Record<string, string[]> = {
  "Matematika": ["Solikah", "Siti", "Wiwin"],
  "Bahasa Indonesia": ["Devi", "Titik"],
  "Bahasa Inggris": ["Fajar", "Kris"],
  "MPKK": ["RR.Henning Gratyanis S.pd", "Alifah Diantebes Aindra S.pd"],
};
...
export default function DetailSiswaStaff({
  ...
  const [rows, setRows] = useState<KehadiranRow[]>([
    ...
    { 
      ...
      mataPelajaran: "MPKK", 
      namaGuru: "RR.Henning Gratyanis S.pd", 
      status: "hadir", 
