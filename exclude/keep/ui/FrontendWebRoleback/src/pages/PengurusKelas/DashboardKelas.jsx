    ...
    <>
      ...
      <div className="dashboard">
              ...
              <div className="profile-avatar">
                {profileImage ? (
                  ...
                  <div className="avatar-icon">
                    <ProfileIcon gender={sampleData.profile.gender} size={80} />
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="content-section">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '24px' }}>
                <div className="kehadiran-card">
                  ...
                  <MultiLineChart data={sampleData.monthlyTrend} />
                </div>
                ...
                <div className="kehadiran-card">
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', flex: '1' }}>
                      {[
                        { label: 'Hadir', value: sampleData.dailyStats.hadir, color: '#1FA83D' },
                        { label: 'Terlambat', value: sampleData.dailyStats.terlambat, color: '#FF5F1A' },
                        { label: 'Pulang', value: sampleData.dailyStats.pulang, color: '#243CB5' },
                        { label: 'Izin', value: sampleData.dailyStats.izin, color: '#EDD329' },
                        { label: 'Sakit', value: sampleData.dailyStats.sakit, color: '#9A0898' },
                        { label: 'Alpha', value: sampleData.dailyStats.alpha, color: '#D90000' }
                      ].map((stat, idx) => (
        ...
        <ProfileModal isOpen={showProfile} onClose={() => setShowProfile(false)} 
          profile={sampleData.profile} currentProfileImage={profileImage}
