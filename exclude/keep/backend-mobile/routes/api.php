...
use App\Http\Controllers\StudentLeavePermissionController;
use App\Http\Controllers\SubjectController;
use App\Http\Controllers\TeacherController;
use App\Http\Controllers\TeacherScheduleDetailController;
...
Route::middleware(['auth:sanctum', 'activity', 'throttle:api'])->group(function (): void {
    ...
    Route::middleware('role:admin')->group(function (): void {
        ...
        Route::get('/students/absences', [AttendanceController::class, 'studentsAbsences']); // Must be before apiResource
    ...
    // Accessible to all admin types (regular admin and waka)
    Route::middleware('role:admin')->group(function (): void {
    ...
    Route::middleware('role:teacher')->group(function (): void {
        ...
        Route::get('/me/schedules/{schedule}/detail', [TeacherScheduleDetailController::class, 'show']);
        Route::get('/me/schedules/{schedule}/students', [TeacherScheduleDetailController::class, 'getStudents']);
        
        // Teacher creates sick/izin for student (full day)
        Route::post('/me/schedules/{schedule}/students/{student}/leave', [TeacherScheduleDetailController::class, 'createStudentLeave']);
        
        // Teacher creates izin pulang/dispensasi for student (temporary)
        Route::post('/me/schedules/{schedule}/students/{student}/leave-early', [TeacherScheduleDetailController::class, 'createLeaveEarly']);
        
        // Teacher marks student as returned from leave
        Route::post('/me/leave-permissions/{leavePermission}/return', [TeacherScheduleDetailController::class, 'markReturned']);
        
        // Teacher marks student as absent (didn't return on time)
        Route::post('/me/leave-permissions/{leavePermission}/mark-absent', [TeacherScheduleDetailController::class, 'markAbsent']);
        
        // Get leave permissions for a class
        Route::get('/classes/{class}/leave-permissions', [TeacherScheduleDetailController::class, 'getClassLeavePermissions']);
        
        // Get students currently on leave for a class
        Route::get('/classes/{class}/students-on-leave', [StudentLeavePermissionController::class, 'studentsOnLeave']);
    ...
    Route::middleware('role:admin,teacher')->group(function (): void {
        Route::get('/leave-permissions', [StudentLeavePermissionController::class, 'index']);
        Route::post('/leave-permissions', [StudentLeavePermissionController::class, 'store']);
        Route::get('/leave-permissions/{permission}', [StudentLeavePermissionController::class, 'show']);
        Route::patch('/leave-permissions/{permission}', [StudentLeavePermissionController::class, 'update']);
        Route::post('/leave-permissions/{permission}/return', [StudentLeavePermissionController::class, 'markReturn']);
        Route::post('/leave-permissions/{permission}/mark-absent', [StudentLeavePermissionController::class, 'markAbsent']);
        Route::post('/leave-permissions/{permission}/cancel', [StudentLeavePermissionController::class, 'cancel']);
        Route::post('/leave-permissions/check-expired', [StudentLeavePermissionController::class, 'checkExpired']);
    });
