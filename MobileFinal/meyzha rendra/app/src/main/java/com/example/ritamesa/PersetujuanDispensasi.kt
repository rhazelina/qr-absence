    ...
    private fun initializeDummyData() {
        allDispensasiList = mutableListOf(
            Dispensasi(
                ...
                jamKe = "1-2",
                guruPengajar = "Ibu Devi Arveni",
                catatan = "Mengikuti lomba",
                status = StatusDispensasi.MENUNGGU
            ),
            Dispensasi(
                namaSiswa = "Rachel Aluna",
                kelas = "12 Rekayasa Perangkat Lunak 2",
                mataPelajaran = "Matematika",
                hari = "Selasa",
                tanggal = "6 Januari 2026",
                jamKe = "3-4",
                guruPengajar = "Ibu Wiwin",
                catatan = "Sakit",
                status = StatusDispensasi.DISETUJUI
            ),
            Dispensasi(
                namaSiswa = "Fidatul Aviva",
                kelas = "12 Rekayasa Perangkat Lunak 1",
                mataPelajaran = "MPKK",
                hari = "Rabu",
                tanggal = "7 Januari 2026",
                jamKe = "5-6",
                guruPengajar = "Pak Zulkifli",
