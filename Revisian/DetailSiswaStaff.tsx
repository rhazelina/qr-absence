...
export default function DetailSiswaStaff({
  ...
  // Data siswa berdasarkan kelasId
  const DATA_SISWA_PER_KELAS: Record<string, KehadiranRow[]> = {
    "1": [
      { id: "1", nisn: "0078980482", namaSiswa: "NOVITA AZZAHRA", mataPelajaran: "Matematika", namaGuru: "WIWIN WINANGSIH, S.Pd,M.Pd", status: "hadir", waktuMasuk: "07:30 WIB", waktuKeluar: "12:00 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "2", nisn: "0079312790", namaSiswa: "RAENA WESTI DHEANOFA HERLIANI", mataPelajaran: "Matematika", namaGuru: "SITTI HADIJAH, S.Pd", status: "hadir", waktuMasuk: "07:25 WIB", waktuKeluar: "12:05 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "3", nisn: "0061631562", namaSiswa: "NADIA SINTA DEVI OKTAVIA", mataPelajaran: "Bahasa Indonesia", namaGuru: "Hj. TITIK MARIYATI, S.Pd", status: "izin", keterangan: "Ijin tidak masuk karena ada keperluan keluarga", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "4", nisn: "1348576395", namaSiswa: "NURUL KHASANAH", mataPelajaran: "Bahasa Inggris", namaGuru: "FAJAR NINGTYAS, S.Pd", status: "sakit", keterangan: "Demam tinggi dan dokter menyarankan istirahat", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "5", nisn: "0076610748", namaSiswa: "RITA AURA AGUSTINA", mataPelajaran: "Matematika", namaGuru: "WIWIN WINANGSIH, S.Pd,M.Pd", status: "tidak-hadir", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "6", nisn: "0072620559", namaSiswa: "SHISILIA ISMU PUTRI", mataPelajaran: "Matematika", namaGuru: "SITTI HADIJAH, S.Pd", status: "tidak-hadir", jamPelajaran: "5-8", tanggal: "25-01-2025" },
      { id: "7", nisn: "0089965810", namaSiswa: "NINDI NARITA MAULIDYA", mataPelajaran: "Matematika", namaGuru: "WIWIN WINANGSIH, S.Pd,M.Pd", status: "hadir", waktuMasuk: "07:45 WIB", waktuKeluar: "11:50 WIB", lokasi: "Sekolah - Gerbang Timur", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "8", nisn: "0074320819", namaSiswa: "LELY SAGITA", mataPelajaran: "MPKK", namaGuru: "RR. HENNING GRATYANIS ANGGRAENI, S.Pd", status: "hadir", waktuMasuk: "07:20 WIB", waktuKeluar: "12:10 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "5-8", tanggal: "26-01-2025" },
      { id: "9", nisn: "0074182519", namaSiswa: "LAURA LAVIDA LOCA", mataPelajaran: "MPKK", namaGuru: "ALIFAH DIANTEBES AINDRA S.Pd", status: "hadir", waktuMasuk: "07:35 WIB", waktuKeluar: "12:00 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "5-8", tanggal: "26-01-2025" },
      { id: "10", nisn: "0081112175", namaSiswa: "NADJWA KIRANA FIRDAUS", mataPelajaran: "MPKK", namaGuru: "ALIFAH DIANTEBES AINDRA S.Pd", status: "hadir", waktuMasuk: "07:40 WIB", waktuKeluar: "12:15 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "1-4", tanggal: "26-01-2025" },
      { id: "11", nisn: "0085834363", namaSiswa: "NISWATUL KHOIRIYAH", mataPelajaran: "MPKK", namaGuru: "RR. HENNING GRATYANIS ANGGRAENI, S.Pd", status: "sakit", keterangan: "Flu berat dan batuk", jamPelajaran: "1-4", tanggal: "26-01-2025" },
      { id: "12", nisn: "0084924963", namaSiswa: "RAYHANUN", mataPelajaran: "Bahasa Inggris", namaGuru: "FAJAR NINGTYAS, S.Pd", status: "izin", keterangan: "Menghadiri acara keluarga", jamPelajaran: "5-8", tanggal: "26-01-2025" },
      { id: "13", nisn: "0081838771", namaSiswa: "RACHEL ALUNA MEIZHA", mataPelajaran: "Matematika", namaGuru: "SOLIKAH, S.Pd", status: "pulang", keterangan: "Pulang lebih awal karena sakit perut", waktuMasuk: "07:30 WIB", waktuKeluar: "10:15 WIB", jamPelajaran: "1-4", tanggal: "26-01-2025" },
    ],
    "2": [
      { id: "1", nisn: "0092341001", namaSiswa: "AMANDA PUTRI SALSABILA", mataPelajaran: "Matematika", namaGuru: "SOLIKAH, S.Pd", status: "hadir", waktuMasuk: "07:28 WIB", waktuKeluar: "12:00 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "2", nisn: "0092341002", namaSiswa: "BERLIANA KUSUMA DEWI", mataPelajaran: "Matematika", namaGuru: "SOLIKAH, S.Pd", status: "hadir", waktuMasuk: "07:30 WIB", waktuKeluar: "12:00 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "3", nisn: "0092341003", namaSiswa: "CITRA MAHARANI", mataPelajaran: "Bahasa Indonesia", namaGuru: "Hj. TITIK MARIYATI, S.Pd", status: "sakit", keterangan: "Sakit demam dan batuk", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "4", nisn: "0092341004", namaSiswa: "DINDA ARUM PUSPITASARI", mataPelajaran: "Bahasa Inggris", namaGuru: "FAJAR NINGTYAS, S.Pd", status: "hadir", waktuMasuk: "07:22 WIB", waktuKeluar: "12:10 WIB", lokasi: "Sekolah - Gerbang Timur", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "5", nisn: "0092341005", namaSiswa: "EKA FITRIANI RAHAYU", mataPelajaran: "Matematika", namaGuru: "SOLIKAH, S.Pd", status: "izin", keterangan: "Keperluan keluarga mendadak", jamPelajaran: "1-4", tanggal: "25-01-2025" },
      { id: "6", nisn: "0092341006", namaSiswa: "FATIMAH AZZAHRA PUTRI", mataPelajaran: "MPKK", namaGuru: "TRIANA ARDIANI, S.Pd", status: "hadir", waktuMasuk: "07:35 WIB", waktuKeluar: "12:00 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "5-8", tanggal: "25-01-2025" },
      { id: "7", nisn: "0092341007", namaSiswa: "GITA PERMATA SARI", mataPelajaran: "MPKK", namaGuru: "TRIANA ARDIANI, S.Pd", status: "tidak-hadir", jamPelajaran: "5-8", tanggal: "25-01-2025" },
      { id: "8", nisn: "0092341008", namaSiswa: "HANA SAFITRI WULANDARI", mataPelajaran: "Matematika", namaGuru: "SITTI HADIJAH, S.Pd", status: "hadir", waktuMasuk: "07:18 WIB", waktuKeluar: "12:05 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "1-4", tanggal: "26-01-2025" },
      { id: "9", nisn: "0092341009", namaSiswa: "INDAH LESTARI NINGRUM", mataPelajaran: "MPKK", namaGuru: "TRIANA ARDIANI, S.Pd", status: "pulang", keterangan: "Pulang lebih awal karena ada keperluan", waktuMasuk: "07:30 WIB", waktuKeluar: "10:00 WIB", jamPelajaran: "5-8", tanggal: "26-01-2025" },
      { id: "10", nisn: "0092341010", namaSiswa: "JIHAN NABILAH SAFIRA", mataPelajaran: "Bahasa Inggris", namaGuru: "FAJAR NINGTYAS, S.Pd", status: "hadir", waktuMasuk: "07:25 WIB", waktuKeluar: "12:00 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "1-4", tanggal: "26-01-2025" },
      { id: "11", nisn: "0092341011", namaSiswa: "KIRANA DEWI ANGGRAINI", mataPelajaran: "Bahasa Indonesia", namaGuru: "Hj. TITIK MARIYATI, S.Pd", status: "izin", keterangan: "Mengikuti lomba seni tingkat kota", jamPelajaran: "1-4", tanggal: "26-01-2025" },
      { id: "12", nisn: "0092341012", namaSiswa: "LAILA NUR AZIZAH", mataPelajaran: "MPKK", namaGuru: "TRIANA ARDIANI, S.Pd", status: "hadir", waktuMasuk: "07:32 WIB", waktuKeluar: "12:10 WIB", lokasi: "Sekolah - Gerbang Utama", jamPelajaran: "5-8", tanggal: "26-01-2025" },
      { id: "13", nisn: "0092341013", namaSiswa: "MARSYA AULIA RAHMA", mataPelajaran: "Matematika", namaGuru: "WIWIN WINANGSIH, S.Pd,M.Pd", status: "dispen", keterangan: "Dispensasi mengikuti lomba olimpiade matematika", jamPelajaran: "1-4", tanggal: "26-01-2025" },
    ],
  };

  const [rows, setRows] = useState<KehadiranRow[]>(DATA_SISWA_PER_KELAS[kelasId] || DATA_SISWA_PER_KELAS["1"]);

  // Update rows setiap kelasId berubah
  useEffect(() => {
    setRows(DATA_SISWA_PER_KELAS[kelasId] || DATA_SISWA_PER_KELAS["1"]);
  }, [kelasId]);
  ...
  const getStatusStyle = (status: string) => {
    ...
    switch (status) {
      ...
      case "dispen":
        return { ...baseStyle, backgroundColor: "#FF3E9B", boxShadow: "0 2px 4px rgba(255, 62, 155, 0.3)" };
      default:
  ...
  const handleExportPDF = () => {
    ...
    try {
      ...
      doc.text(`Dispen: ${totalDispen}`, 14, summaryY + 42);
      doc.text(`Total Siswa: ${filteredRows.length}`, 14, summaryY + 49);
  ...
  const DetailRow = ({ label, value }: { label: string; value: string }) => (
    <div style={{
      ...
      <div style={{ fontWeight: 600, color: "#374151", fontSize: "14px", width: 16, flexShrink: 0, textAlign: "center" }}>:</div>
    ...
    <StaffLayout pageTitle={`Detail Kehadiran - ${kelasInfo.namaKelas}`} currentPage={currentPage} onMenuClick={onMenuClick} user={user} onLogout={onLogout}>
      <div style={{ position: "relative", minHeight: "100%", backgroundColor: "#FFFFFF", borderRadius: 12, overflow: "hidden", padding: isMobile ? 16 : 32, border: "1px solid #E5E7EB", boxShadow: "0 4px 12px rgba(0,0,0,0.08)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2,1fr)" : "repeat(6,1fr)", gap: 12, marginBottom: 16 }}>
          ...
          <SummaryCard label="Dispen" value={totalDispen.toString()} color="#FF3E9B" /> {/* BOLD PINK */}
        </div>
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <div style={{ fontWeight: 600, color: "#374151", fontSize: "14px", width: 130, flexShrink: 0 }}>Status</div>
                <div style={{ fontWeight: 600, color: "#374151", fontSize: "14px", width: 16, flexShrink: 0, textAlign: "center" }}>:</div>
              ...
              {(selectedRow.status === "hadir" || selectedRow.status === "alpha" || selectedRow.status === "tidak-hadir" || selectedRow.status === "dispen") && (
                <div style={{
                  backgroundColor: selectedRow.status === "hadir" ? "#F0FDF4" : selectedRow.status === "dispen" ? "#FFF0F7" : "#F3F4F6",
                  borderRadius: 8,
                  padding: "16px 20px",
                  textAlign: "center",
                  marginBottom: 20,
                  border: selectedRow.status === "hadir" ? "1px solid #DCFCE7" : selectedRow.status === "dispen" ? "1px solid #FFD6EC" : "1px solid #E5E7EB",
                }}>
                  <div style={{
                    fontSize: 14,
                    fontWeight: 500,
                    color: selectedRow.status === "hadir" ? "#166534" : selectedRow.status === "dispen" ? "#FF3E9B" : "#374151",
                  }}>
              ...
              {/* Keterangan tambahan untuk izin, sakit, pulang, dan dispen */}
              {(selectedRow.status === "izin" || selectedRow.status === "sakit" || selectedRow.status === "pulang" || selectedRow.status === "dispen") && selectedRow.keterangan && (
                <>
                  <div>
                    <div style={{
                      fontSize: 14,
              ...
              {(selectedRow.status === "izin" || selectedRow.status === "sakit" || selectedRow.status === "pulang" || selectedRow.status === "dispen") && (
